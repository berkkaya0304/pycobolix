def main():
    ...
    tier_level = input("Tier (1=Basic $20, 2=Pro $40, 3=Elite $75): ").strip()
    ...
    shipping = 0.0 if tier_level == '3' else 5.00
    ...
    print("---------------------------------------")
    print(f"Monthly Base Box:   ${base_price:6.2f}")
    
    if addon_price > 0:
        print(f"Monthly Add-ons:    ${addon_price:6.2f}")
        
    print(f"Shipping Fee:       ${shipping:6.2f}")
    print("---------------------------------------")
    print(f"TOTAL MONTHLY CHARGE: ${monthly_total:6.2f}")
