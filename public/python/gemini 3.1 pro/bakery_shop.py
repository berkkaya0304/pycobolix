def main():
    ...
    if cake_qty > 0:
        print(f"{cake_qty} x Cakes:         ${cake_tot:8.2f}")
    if bread_qty > 0:
        print(f"{bread_qty} x Bread Loaves:  ${bread_tot:8.2f}")
    if pastry_qty > 0:
        print(f"{pastry_qty} x Pastries:      ${pastry_tot:8.2f}")
        
    print("-----------------------------------------")
    print(f"Subtotal:         ${sub_total:8.2f}")
    if discount > 0:
        print(f"Bulk Discount:   -${discount:8.2f}")
    print("-----------------------------------------")
    print(f"TOTAL DUE:        ${final_tot:8.2f}")
    print("=========================================")
