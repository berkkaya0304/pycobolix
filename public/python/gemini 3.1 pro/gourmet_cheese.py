def main():
    ...
    if brie_lbs > 0:
        print(f"Brie ({brie_lbs:.2f} lbs):        ${b_tot:6.2f}")
    if cheddar_lbs > 0:
        print(f"Cheddar ({cheddar_lbs:.2f} lbs):     ${c_tot:6.2f}")
    if gouda_lbs > 0:
        print(f"Gouda ({gouda_lbs:.2f} lbs):       ${g_tot:6.2f}")
    if cracker_boxes > 0:
        print(f"Crackers ({cracker_boxes} boxes):   ${k_tot:6.2f}")
        
    print("----------------------------------------")
    print(f"TOTAL SALE:          ${grand_tot:6.2f}")
    print("========================================")
