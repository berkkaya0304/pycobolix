"""
Bug Busters Exterminating - Pest Control
Converted from COBOL (pest_control.cbl) to Python
"""
...
def main():
    ...
    print("----------------------------------------")
    print(f"Property Area Charge:${area_charge:>9,.2f}")
    if pest_surchg > 0:
        print(f"Target Pest Surcharge: ${pest_surchg:>7,.2f}")
    if sub_monthly == "Y":
        print(f"Service Plan Disc:  -${sub_discount:>8,.2f}")
    print("----------------------------------------")
    print(f"TOTAL TREATMENT:      ${final_due:>7,.2f}")
    print("========================================")
