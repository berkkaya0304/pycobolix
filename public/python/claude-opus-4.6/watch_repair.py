"""
Tic-Tock Watch Repair
Converted from COBOL (watch_repair.cbl) to Python
"""
...
def main():
    ...
    print("----------------------------------------")
    if sv_battery == "Y":
        print(f"Battery Service:    ${batt_fee:>9,.2f}")
    if sv_strap == "Y":
        print(f"Strap Replacement:  ${strap_fee:>9,.2f}")
    if sv_polish == "Y":
        print(f"Polishing Service:  ${polish_fee:>9,.2f}")
    print("----------------------------------------")
    if luxury_tier == "Y":
        print(f"Luxury Brand Fee:   ${luxury_surchg:>9,.2f}")
    print("----------------------------------------")
    print(f"TOTAL SERVICE COST: ${grand_tot:>9,.2f}")
    print("========================================")
