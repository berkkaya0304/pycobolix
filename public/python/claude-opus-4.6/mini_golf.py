"""
Gator Golf Adventure - Mini Golf
Converted from COBOL (mini_golf.cbl) to Python
"""
...
def main():
    ...
    print("----------------------------------------")
    if adult_qty > 0:
        print(f"{adult_qty}x Adult Tickets:   ${adult_tot:>9,.2f}")
    if child_qty > 0:
        print(f"{child_qty}x Child Tickets:   ${child_tot:>9,.2f}")
    print("----------------------------------------")
