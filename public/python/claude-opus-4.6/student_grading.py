...
Converted from COBOL (student_grading.cbl) to Python
"""
...
def main():
    ...
    while want_to_exit.upper() != "Y":
        ...
        if average_mark >= 90:
            letter_grade, pass_fail = "A", "PASS"
        elif average_mark >= 80:
            letter_grade, pass_fail = "B", "PASS"
        elif average_mark >= 70:
            letter_grade, pass_fail = "C", "PASS"
        elif average_mark >= 60:
            letter_grade, pass_fail = "D", "PASS"
        else:
            letter_grade, pass_fail = "F", "FAIL"
