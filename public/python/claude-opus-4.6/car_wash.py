"""
Sparkle Car Wash
Converted from COBOL (car_wash.cbl) to Python
"""
...
def main():
    ...
    print("---------------------------------------------")
    print(f"Wash Package Fee:    ${base_fee:>9,.2f}")
    if wax_fee > 0:
        print(f"Hand Wax Add-on:     ${wax_fee:>9,.2f}")
    print("---------------------------------------------")
    print(f"Subtotal:            ${sub_total:>9,.2f}")
    print(f"Crew Tip:            ${tip_amount:>9,.2f}")
    print("=============================================")
    print(f"TOTAL CHARGED:       ${total_charge:>9,.2f}")
