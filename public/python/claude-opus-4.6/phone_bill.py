"""
Telecom Monthly Statement - Phone Bill
Converted from COBOL (phone_bill.cbl) to Python
"""
...
def main():
    ...
    print("---------------------------------------")
    print(f"Plan Base Charge:    ${base_charge:>9,.2f}")
    if overage_charge > 0:
        print(f"Data Overage Fees:   ${overage_charge:>9,.2f}")
    if intl_charge > 0:
        print(f"Int'l Call Charges:  ${intl_charge:>9,.2f}")
    print("---------------------------------------")
    print(f"Taxes & Surcharges:  ${taxes:>9,.2f}")
