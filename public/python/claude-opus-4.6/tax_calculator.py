...
Converted from COBOL (tax_calculator.cbl) to Python
"""
...
def main():
    ...
    print("----------------------------------------")
    print(f"Gross Income:     ${gross_income:>14,.2f}")
    print(f"Deductions:      -${deductions:>13,.2f}")
    print(f"Taxable Income:   ${taxable_income:>14,.2f}")
    print("----------------------------------------")
    print(f"Dependent Credit:-${dependent_ded:>13,.2f}")
    print(f"TOTAL TAX OWED:   ${tax_owed:>14,.2f}")
    print("========================================")
