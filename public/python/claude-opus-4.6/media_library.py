"""
City Library Returns - Media Library Fine System
Converted from COBOL (media_library.cbl) to Python
"""
...
def main():
    ...
    if days_overdue == 0:
        ...
        print(f"Late Fine:         ${calc_fine:>9,.2f}")
        if process_fee > 0:
            print(f"Processing Fee:    ${process_fee:>9,.2f}")
        print("----------------------------------------")
        print(f"TOTAL DUE:         ${total_bill:>9,.2f}")
    print("========================================")
