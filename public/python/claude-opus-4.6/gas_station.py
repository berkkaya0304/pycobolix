"""
Fast Fill Gas Station
Converted from COBOL (gas_station.cbl) to Python
"""
...
def main():
    ...
    wash_fee = 8.00 if car_wash == "Y" else 0.0
    ...
    print("=======================================")
    print(f"Gallons Dispensed: {gallons_pumped}")
    print(f"Price per Gallon:  ${price_per_gal}")
    print("---------------------------------------")
    print(f"Fuel Charge:       ${fuel_total:>9,.2f}")
    if car_wash == "Y":
        print(f"Car Wash Add-on:   ${wash_fee:>9,.2f}")
        print("   -> Wash Code: 49813 <-")
    print("---------------------------------------")
    print(f"TOTAL SALE:        ${grand_total:>9,.2f}")
    print("=======================================")
