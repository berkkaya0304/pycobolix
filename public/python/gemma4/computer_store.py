def main():
    ...
    cpu_choice = input("Select CPU: 1=i5($200), 2=i7($350), 3=i9($550): ")
    ram_choice = input("Select RAM: 1=16GB($80), 2=32GB($150): ")
    gpu_choice = input("Select GPU: 1=RTX4060($300), 2=RTX4080($900): ")
