# FOOD-DELIVERY - Quick Dash Food Delivery
...
def main():
    ...
    print("----------------------------------------")
    print(f"Food Subtotal:      ${food_subtotal:,.2f}")
    print(f"Delivery Distance:  ${delivery_fee:,.2f}")
    print(f"App Service Fee:    ${service_fee:,.2f}")
    print(f"Local Taxes:        ${tax_amt:,.2f}")
    print(f"Driver Tip:         ${driver_tip:,.2f}")
    print("----------------------------------------")
    print(f"TOTAL CHARGE:       ${grand_tot:,.2f}")
    print("========================================")
