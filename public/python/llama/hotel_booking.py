# HOTEL-BOOKING - Seaside Resort Booking
...
def main():
    ...
    print("------------------------------------")
    print(f"Est. Nightly Rate: ${nightly_rate:,.2f}")
    print(f"Room Subtotal:     ${subtotal:,.2f}")
    print(f"Taxes (12.5%):     ${taxes:,.2f}")
    print("------------------------------------")
    print(f"TOTAL STAY COST:   ${grand_total:,.2f}")
    print("====================================")
