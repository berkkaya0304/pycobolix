# PATIENT-BILLING - General Hospital Billing
...
def main():
    ...
    print(f"Room Charges:    ${room_chg:,.2f}")
    print(f"Surgery:         ${surgery_chg:,.2f}")
    print(f"Medication:      ${medication_chg:,.2f}")
    print("-----------------------------------------")
    print(f"GROSS TOTAL:     ${total_chg:,.2f}")
    print(f"Insurance Pays: -${insur_cover:,.2f}")
    print("=========================================")
    print(f"PATIENT TO PAY:  ${patient_owes:,.2f}")
    print("=========================================")
