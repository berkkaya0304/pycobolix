"""
HR Salary Invoicing - Salary Slip
Converted from COBOL (salary_slip.cbl) to Python
"""
...
def main():
    ...
    print("----------------------------------------")
    print("EARNINGS:")
    print(f"  Basic Pay:  ${basic_pay:>12,.2f}")
    print(f"  HRA (20%):  ${hra:>12,.2f}")
    print(f"  DA (10%):   ${da:>12,.2f}")
    print(f"  Transport:  ${transport:>12,.2f}")
    print("----------------------------------------")
    print(f"GROSS PAY:    ${gross_salary:>12,.2f}")
    print("----------------------------------------")
    print("DEDUCTIONS:")
    ...
    print("----------------------------------------")
    print(f"TOTAL DEDUCT: ${total_ded:>12,.2f}")
    print("========================================")
    print(f"NET PAY (TAKE HOME): ${net_pay:>12,.2f}")
    print("========================================")
