"""
Clay Creations Studio - Pottery Class
Converted from COBOL (pottery_class.cbl) to Python
"""
...
def main():
    ...
    print("----------------------------------------")
    print(f"Studio Access Fee:  ${studio_fee:>9,.2f}")
    if clay_lbs > 0:
        print(f"Clay ({clay_lbs} lbs):      ${clay_fee:>9,.2f}")
    if kiln_firing > 0:
        print(f"Kiln Firing ({kiln_firing}):   ${kiln_fee:>9,.2f}")
    print("----------------------------------------")
    print(f"TOTAL COST:         ${grand_tot:>9,.2f}")
    print("========================================")
