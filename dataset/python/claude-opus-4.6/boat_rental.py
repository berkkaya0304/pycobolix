"""
Lakeside Marina Boat Rental
Converted from COBOL (boat_rental.cbl) to Python
"""
...
def main():
    ...
    print("----------------------------------------")
    print(f"Vessel Rental Fee:  ${boat_total:>9,.2f}")
    if jacket_fee > 0:
        print(f"Life Jacket Rental: ${jacket_fee:>9,.2f}")
    if insur_fee > 0:
        print(f"Damage Insurance:   ${insur_fee:>9,.2f}")
    print("----------------------------------------")
    print(f"TOTAL BALANCE DUE:  ${gross_amt:>9,.2f}")
    print("========================================")
