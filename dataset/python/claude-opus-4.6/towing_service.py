"""
Highway Hero Towing Service
Converted from COBOL (towing_service.cbl) to Python
"""
...
def main():
    ...
    if veh_type == 1:
        hook_fee, mile_rate = 75.00, 3.50
    elif veh_type == 2:
        hook_fee, mile_rate = 125.00, 5.00
    elif veh_type == 3:
        hook_fee, mile_rate = 60.00, 3.00
    else:
        hook_fee, mile_rate = 75.00, 3.50
    ...
    print("----------------------------------------")
    print(f"Base Hookup Fee:     ${hook_fee:>9,.2f}")
    print(f"Mileage ({tow_miles}m):     ${mile_tot:>9,.2f}")
    if wintch_out == "Y":
        print(f"Winch-Out Surcharge: ${wintch_fee:>9,.2f}")
    print("----------------------------------------")
    print(f"TOTAL TOW BILL:      ${grand_tot:>9,.2f}")
    print("========================================")
