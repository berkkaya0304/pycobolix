"""
Elegance Event Catering - Wedding Catering
Converted from COBOL (wedding_catering.cbl) to Python
"""
...
def main():
    ...
    print("----------------------------------------")
    print(f"Food & Dining Cost:  ${food_tot:>12,.2f}")
    if bar_cost > 0:
        print(f"Open Bar Setup:      ${bar_cost:>12,.2f}")
    print(f"Staffing/Gratuity(20%) ${gratuity:>10,.2f}")
    print("----------------------------------------")
    print(f"ESTIMATED TOTAL:     ${grand_total:>12,.2f}")
    print("========================================")
