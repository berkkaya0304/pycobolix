"""
Enigma Escape Rooms
Converted from COBOL (escape_room.cbl) to Python
"""
...
def main():
    ...
    print("----------------------------------------")
    print(f"Price Per Ticket:    ${ticket_price:>9,.2f}")
    print(f"Base Room Charge:    ${room_tot:>9,.2f}")
    if weekend_fee > 0:
        print(f"Weekend Premium:     ${weekend_fee:>9,.2f}")
    print("----------------------------------------")
    print(f"TOTAL AMOUNT DUE:    ${final_bill:>9,.2f}")
    print("========================================")
