def main():
    ...
    pass_type = input("Pass (1=Half Day $60, 2=Full $95, 3=3-Day $250): ").strip()
    ...
    print("----------------------------------------")
    print(f"Lift Ticket Access:  ${lift_ticket:6.2f}")
    
    if gear_fee > 0:
        print(f"Equipment Rental:    ${gear_fee:6.2f}")
        
    if helmet_fee > 0:
        print(f"Helmet Rental:       ${helmet_fee:6.2f}")
        
    print("----------------------------------------")
    print(f"TOTAL PAID:          ${total_cost:6.2f}")
