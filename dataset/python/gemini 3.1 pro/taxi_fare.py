def main():
    ...
    print("----------------------------------------")
    print(f"Initial Drop:       ${base_drop:6.2f}")
    print(f"Mileage Fare:       ${distance_fee:6.2f}")
    
    if time_fee > 0:
        print(f"Wait/Idle Time:     ${time_fee:6.2f}")
        
    if night_surcharge:
        print(f"Night Surcharge:    ${night_fee:6.2f}")
        
    print("----------------------------------------")
    print(f"TOTAL FARE DUE:     ${total_fare:6.2f}")
    print("========================================")
