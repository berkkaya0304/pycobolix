def main():
    ...
    print("----------------------------------------")
    print(f"Games Total:        ${total_games:6.2f}")
    
    if total_shoes > 0:
        print(f"Shoe Rentals ({shoe_rentals}):  ${total_shoes:6.2f}")
        
    if league_member:
        print(f"League Discount:   -${league_disc:6.2f}")
        
    print("----------------------------------------")
    print(f"TOTAL LANE FEE:     ${net_amt:6.2f}")
    print("========================================")
